...
def daily_remainder(username, doc_name, slot_time, date):
    ...
    url = "https://chat.googleapis.com/v1/spaces/AAQAjfJGmSE/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=qYvNdoUUmqBAcgXIix9-E5D4VqgmPgqWJcBIMyYQYno"
