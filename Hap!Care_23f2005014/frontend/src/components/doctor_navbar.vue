...
<div v-if="sidebarOpen" class="sidebar-backdrop" @click.self="sidebarOpen = false">
  <div class="sidebar">
    <div class="sidebar-header mb-4 d-flex align-items-center">
      ...
      <div>
        <div class="sidebar-title">Doctor Panel</div>
    ...
    <!-- <div class="search-container">
      <form class="d-flex search-form" @submit.prevent="searchquery">
        <input
          ...
          type="search"
          v-model="query"
          placeholder="Search patients,etc."
          required
        />
    ...
    <ul class="list-unstyled mt-2">
      <li>
        <RouterLink to="/doctor_profile" class="sidebar-link">
          <i class="bi bi-person-circle sidebar-icon"></i> Profile
        </RouterLink>
      </li>
      <li>
        <RouterLink to="/doctor_dashboard" class="sidebar-link">
          <i class="bi bi-person-badge sidebar-icon"></i> Dashboard
        </RouterLink>
      </li>
      <li>
        <RouterLink to="/doctor_patient" class="sidebar-link">
          <i class="fa-solid fa-user-doctor sidebar-icon"></i> Patients
        </RouterLink>
      </li>
